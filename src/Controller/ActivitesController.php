...
class ActivitesController extends AbstractController
{
    ...
    public function bilanPdf(
        ...
        $projectDirForPdf = $this->getParameter('kernel.project_dir');
        assert(is_string($projectDirForPdf));
    ...
    private function generateBilanWithDompdf(ActiviteRepository $activiteRepo): Response
    {
        ...
        $projectDirDompdf = $this->getParameter('kernel.project_dir');
        assert(is_string($projectDirDompdf));
