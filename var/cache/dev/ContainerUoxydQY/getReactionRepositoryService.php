...
class getReactionRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ReactionRepository.php';

        return $container->privates['App\\Repository\\ReactionRepository'] = new \App\Repository\ReactionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
