 ...
 */
class getDemandeReservationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandeReservationRepository' shared autowired service.
     *
     * @return \App\Repository\DemandeReservationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandeReservationRepository.php';

        return $container->privates['App\\Repository\\DemandeReservationRepository'] = new \App\Repository\DemandeReservationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
