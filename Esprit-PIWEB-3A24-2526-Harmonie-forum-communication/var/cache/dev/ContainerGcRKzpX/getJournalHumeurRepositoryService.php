 ...
 */
class getJournalHumeurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JournalHumeurRepository' shared autowired service.
     *
     * @return \App\Repository\JournalHumeurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JournalHumeurRepository.php';

        return $container->privates['App\\Repository\\JournalHumeurRepository'] = new \App\Repository\JournalHumeurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
