 ...
 */
class getSessionMeditationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SessionMeditationRepository' shared autowired service.
     *
     * @return \App\Repository\SessionMeditationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SessionMeditationRepository.php';

        return $container->privates['App\\Repository\\SessionMeditationRepository'] = new \App\Repository\SessionMeditationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
