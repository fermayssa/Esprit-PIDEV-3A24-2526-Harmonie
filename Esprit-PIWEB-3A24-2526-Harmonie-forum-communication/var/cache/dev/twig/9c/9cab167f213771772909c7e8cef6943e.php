...
class __TwigTemplate_306c722f5d3571ef24ada8d3d19d6674 extends Template
{
...
";
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 170
        yield from $this->load("_planning_topbar.html.twig", 170)->unwrap()->yield($context);
        // line 171
...
<div class=\"kan-page\"
    ...
    <div class=\"kan-top\">
        ...
        // line 178
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["advice"]) || array_key_exists("advice", $context) ? $context["advice"] : (function () { throw new RuntimeError('Variable "advice" does not exist.', 178, $this->source); })()), "html", null, true);
        yield "</p>
    ...
    <div class=\"kan-board\" id=\"kan-board-root\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["columns"]) || array_key_exists("columns", $context) ? $context["columns"] : (function () { throw new RuntimeError('Variable "columns" does not exist.', 194, $this->source); })()), "A_FAIRE", [], "any", false, false, false, 194));
        foreach ($context['_seq'] as $context["_key"] => $context["tache"]) {
            // line 195
            yield "                        ";
            yield $macros["kan"]->getTemplateForMacro("macro_kan_card", $context, 195, $this->getSourceContext())->macro_kan_card(...[$context["tache"], (isset($context["today"]) || array_key_exists("today", $context) ? $context["today"] : (function () { throw new RuntimeError('Variable "today" does not exist.', 195, $this->source); })())]);
            yield "
                    ";
        }
        ...
        // line 205
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["columns"]) || array_key_exists("columns", $context) ? $context["columns"] : (function () { throw new RuntimeError('Variable "columns" does not exist.', 205, $this->source); })()), "EN_COURS", [], "any", false, false, false, 205));
        foreach ($context['_seq'] as $context["_key"] => $context["tache"]) {
            // line 206
            yield "                        ";
            yield $macros["kan"]->getTemplateForMacro("macro_kan_card", $context, 206, $this->getSourceContext())->macro_kan_card(...[$context["tache"], (isset($context["today"]) || array_key_exists("today", $context) ? $context["today"] : (function () { throw new RuntimeError('Variable "today" does not exist.', 206, $this->source); })())]);
            yield "
                    ";
        }
        $_parent = $context['_parent'];
        ...
        // line 216
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["columns"]) || array_key_exists("columns", $context) ? $context["columns"] : (function () { throw new RuntimeError('Variable "columns" does not exist.', 216, $this->source); })()), "TERMINEE", [], "any", false, false, false, 216));
        foreach ($context['_seq'] as $context["_key"] => $context["tache"]) {
            // line 217
            yield "                        ";
            yield $macros["kan"]->getTemplateForMacro("macro_kan_card", $context, 217, $this->getSourceContext())->macro_kan_card(...[$context["tache"], (isset($context["today"]) || array_key_exists("today", $context) ? $context["today"] : (function () { throw new RuntimeError('Variable "today" does not exist.', 217, $this->source); })())]);
            yield "
                    ";
        }
        $_parent = $context['_parent'];
    ...
    <template id=\"harmony-tpl-tache-form-new\">
        ";
        // line 238
        yield from $this->load("tache/_form_panel.html.twig", 238)->unwrap()->yield(CoreExtension::toArray(["form" => (isset($context["tacheFormNew"]) || array_key_exists("tacheFormNew", $context) ? $context["tacheFormNew"] : (function () { throw new RuntimeError('Variable "tacheFormNew" does not exist.', 238, $this->source); })()), "panel_mode" => "new"]));
        // line 239
        yield "    </template>
</div>
</main>
...
";
    ...
    {
        return array (  739 => 23,  733 => 20,  730 => 19,  724 => 17,  721 => 16,  715 => 13,  702 => 9,  700 => 8,  696 => 7,  691 => 6,  688 => 5,  685 => 4,  666 => 3,  424 => 246,  421 => 245,  408 => 244,  394 => 239,  392 => 238,  371 => 219,  362 => 217,  358 => 216,  348 => 208,  339 => 206,  335 => 205,  325 => 197,  316 => 195,  312 => 194,  299 => 184,  290 => 178,  285 => 176,  281 => 175,  277 => 174,  272 => 171,  270 => 170,  257 => 169,  114 => 36,  110 => 35,  105 => 34,  92 => 33,  69 => 31,  58 => 1,  56 => 29,  43 => 1,);
    }
...
{% endblock %}
", "tache/index.html.twig", "C:\\Users\\user\\Downloads\\Esprit-PIWEB-3A24-2526-Harmonie-forum-communication\\Esprit-PIWEB-3A24-2526-Harmonie-forum-communication\\templates\\tache\\index.html.twig");
    }
}
